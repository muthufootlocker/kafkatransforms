...
public class CustomInnerTimestampConverterTest {
    ...
    private final CustomInnerTimestampConverter<SourceRecord> xformKey = new CustomInnerTimestampConverter.Key<>();
    private final CustomInnerTimestampConverter<SourceRecord> xformValue = new CustomInnerTimestampConverter.Value<>();
    ...
    public void testConfigInvalidTargetType() {
        assertThrows(ConfigException.class,
                () -> xformValue.configure(Collections.singletonMap(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "invalid")));
    }

    @Test
    public void testConfigInvalidUnixPrecision() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "unix");
        config.put(CustomInnerTimestampConverter.UNIX_PRECISION_CONFIG, "invalid");
    ...
    public void testConfigValidUnixPrecision() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "unix");
        config.put(CustomInnerTimestampConverter.UNIX_PRECISION_CONFIG, "seconds");
    ...
    public void testConfigMissingFormat() {
        assertThrows(ConfigException.class,
                () -> xformValue.configure(Collections.singletonMap(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "string")));
    }

    @Test
    public void testConfigInvalidFormat() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "string");
        config.put(CustomInnerTimestampConverter.FORMAT_CONFIG, "bad-format");
        assertThrows(ConfigException.class, () -> xformValue.configure(config));
    }
    ...
    public void testSchemalessIdentity() {
        xformValue.configure(Collections.singletonMap(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp"));
    ...
    public void testSchemalessTimestampToDate() {
        xformValue.configure(Collections.singletonMap(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Date"));
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME.getTime()));
    ...
    public void testSchemalessTimestampToTime() {
        xformValue.configure(Collections.singletonMap(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Time"));
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME.getTime()));
    ...
    public void testSchemalessTimestampToUnix() {
        xformValue.configure(Collections.singletonMap(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "unix"));
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME.getTime()));
    ...
    public void testSchemalessTimestampToString() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "string");
        config.put(CustomInnerTimestampConverter.FORMAT_CONFIG, STRING_DATE_FMT);
    ...
    public void testSchemalessStringToTimestamp() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(CustomInnerTimestampConverter.FORMAT_CONFIG, STRING_DATE_FMT);
        xformValue.configure(config);
    ...
    private void testSchemalessNullValueConversion(String targetType) {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, targetType);
        config.put(CustomInnerTimestampConverter.FORMAT_CONFIG, STRING_DATE_FMT);
        xformValue.configure(config);
    ...
    private void testSchemalessNullFieldConversion(String targetType) {
        ...
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, targetType);
        config.put(CustomInnerTimestampConverter.FORMAT_CONFIG, STRING_DATE_FMT);
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "ts");
        xformValue.configure(config);
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(null));
    ...
    public void testWithSchemaNullValueToTimestamp() {
        testWithSchemaNullValueConversion("Timestamp", Schema.OPTIONAL_INT64_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", Schema.OPTIONAL_STRING_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
    }

    @Test
    public void testWithSchemaNullFieldToTimestamp() {
        testWithSchemaNullFieldConversion("Timestamp", Schema.OPTIONAL_INT64_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", Schema.OPTIONAL_STRING_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA);
    }
    ...
    public void testWithSchemaNullValueToUnix() {
        ...
        testWithSchemaNullValueConversion("unix", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullValueConversion("unix", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullValueConversion("unix", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullValueConversion("unix", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
    }
    ...
    public void testWithSchemaNullFieldToUnix() {
        ...
        testWithSchemaNullFieldConversion("unix", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullFieldConversion("unix", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullFieldConversion("unix", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullFieldConversion("unix", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
    }

    @Test
    public void testWithSchemaNullValueToTime() {
        testWithSchemaNullValueConversion("Time", Schema.OPTIONAL_INT64_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", Schema.OPTIONAL_STRING_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
    }

    @Test
    public void testWithSchemaNullFieldToTime() {
        testWithSchemaNullFieldConversion("Time", Schema.OPTIONAL_INT64_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", Schema.OPTIONAL_STRING_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA);
    }

    @Test
    public void testWithSchemaNullValueToDate() {
        testWithSchemaNullValueConversion("Date", Schema.OPTIONAL_INT64_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", Schema.OPTIONAL_STRING_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
    }

    @Test
    public void testWithSchemaNullFieldToDate() {
        testWithSchemaNullFieldConversion("Date", Schema.OPTIONAL_INT64_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", Schema.OPTIONAL_STRING_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA);
    }
    ...
    public void testWithSchemaNullValueToString() {
        ...
        testWithSchemaNullValueConversion("string", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullValueConversion("string", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullValueConversion("string", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullValueConversion("string", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
    }
    ...
    public void testWithSchemaNullFieldToString() {
        ...
        testWithSchemaNullFieldConversion("string", CustomInnerTimestampConverter.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullFieldConversion("string", CustomInnerTimestampConverter.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullFieldConversion("string", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullFieldConversion("string", CustomInnerTimestampConverter.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
    }
    ...
    public void testSchemalessFieldConversion() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Date");
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "ts");
        xformValue.configure(config);
    ...
    public void testWithSchemaFieldConversion_Micros() {
        ...
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "ts");
        config.put(CustomInnerTimestampConverter.UNIX_PRECISION_CONFIG, "microseconds");
        xformValue.configure(config);
    ...
    public void testWithSchemaFieldConversion_Nanos() {
        ...
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "ts");
        config.put(CustomInnerTimestampConverter.UNIX_PRECISION_CONFIG, "nanoseconds");
        xformValue.configure(config);
    ...
    @Test
    public void testKey() {
        xformKey.configure(Collections.singletonMap(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp"));
    ...
    public void testSchemalessFieldConversion_1() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "info.ts");
        //config.put(CustomInnerTimestampConverter.FORMAT_CONFIG, STRING_DATE_FMT);
        xformValue.configure(config);
        ...
        assertNull(transformed.valueSchema());
        java.util.Date actual = JsonPath.read(transformed.value(), config.get(CustomInnerTimestampConverter.FIELD_CONFIG));
    ...
    public void testWithSchemaFieldConversion1() {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "users[*].age");
        xformValue.configure(config);
        ...
        JSONArray actual = JsonPath.read(transformed.value(), config.get(CustomInnerTimestampConverter.FIELD_CONFIG));
    ...
    public void testWithSubArrayObjDateFieldConversion() throws IOException {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "hello[*].date");
        xformValue.configure(config);
    ...
    public void testWithSubArrayObjDateFieldConversionWithWrongPath() throws IOException {
        Map<String, String> config = new HashMap<>();
        config.put(CustomInnerTimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(CustomInnerTimestampConverter.FIELD_CONFIG, "hello1[*].date");
        xformValue.configure(config);
